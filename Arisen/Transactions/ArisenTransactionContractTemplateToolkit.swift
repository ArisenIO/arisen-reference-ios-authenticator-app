//
//  ArisenTransactionContractTemplateToolkit.swift
//
...
public extension ArisenTransaction {
    ...
    class ContractTemplateToolkit {
        ...
        func ricardian(abi: String, transaction: String, index: Int, strictParsingCTT: Bool) -> ArisenTransaction.Action.Ricardian?  {
            print("*****RICARDIAN")
            print(transaction)
            print("--------------------------")
            var errors: [String] = []
            ...
            let ricardian = ArisenTransaction.Action.Ricardian()
