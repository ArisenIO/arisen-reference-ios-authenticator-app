...
class ImportKeyTableViewController: UITableViewController {
    ...
    private let vault = ArisenVault(accessGroup: Constants.vaultAccessGroup)
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.navigationBar.largeTitleTextAttributes = ArisenAppearance.navBarLargeTitleAttributes
        ...
        self.privateKeyField.attributedPlaceholder = NSAttributedString(string: "Paste Key", attributes: ArisenAppearance.placeHolderStringAttributes)
        self.keyNameField.attributedPlaceholder = NSAttributedString(string: "Choose Nickname", attributes: ArisenAppearance.placeHolderStringAttributes)
    ...
    func importKey(key: String, name: String) throws {
        var key = try vault.addExternal(arisenPrivateKey: key)
        key.name = name
    ...
    func validateKey(keyString: String) -> Error? {
        ...
        do {
            let _ = try Data.init(arisenPrivateKey: keyString)
            return nil
        } catch {
            return error.arisenError
        }
    }
