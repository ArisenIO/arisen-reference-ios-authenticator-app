...
class SelectiveDisclosureViewController: UIViewController {
    ...
    @IBOutlet weak var allowButton: ArisenButton!
    @IBOutlet weak var declineButton: ArisenButton!
    ...
    var request: ArisenReferenceAuthenticatorSignatureProvider.SelectiveDisclosureRequest?
    var reply: ((Bool)->Void)?
