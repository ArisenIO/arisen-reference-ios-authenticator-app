...
@testable import ArisenReferenceAuthenticator
...
class ValidationTests: XCTestCase {
    ...
    let jsonData = """
{
    "name" : "Arisen Reference Authenticator App",
    "shortname" : "Arisen Reference Authenticator",
    "scope" : "/",
    "apphome" : "/",
    "icon" : "/icon.png#b3f9c204715b2d618790a2dcbcbeb7d485c873d4482ef1a9fc3f2a77fb6ac0aa",
    "description" : "Transfer tokens between accounts on an Arisen blockchain",
